export default defineI18nConfig(() => ({
    messages: {
        ro: {
            ...
            whatAwaitsYou: {
                h1: '+70',
                p1: 'ani de experiență în educație și cercetare în domeniul electrotehnicii',
                h2: '3.000',
                p2: 'ingineri absolvenți pregătiți pentru cariere de succes în industrie și cercetare',
                h3: '+100',
                p3: 'doctori ingineri formați în cadrul departamentului, contribuind la dezvoltarea tehnologică'
            },
            student: {

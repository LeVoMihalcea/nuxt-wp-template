<script setup lang="ts">
    ...
    const {data, status} = useSingleLaboratory(id);
            ...
            <two-columns-responsive reverse-if-on-mobile>
                ...
                <template #second>
                    <div class="flex flex-column justify-content-center align-items-center">
                        ...
                        <div class="flex flex-row w-full justify-content-center flex-wrap">
                            <span v-for="equipment of data?.equipments" class="lg:m-2 m-1">
